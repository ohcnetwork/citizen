    ...
    <div className="flex overflow-hidden shadow bg-white rounded-lg flex-col h-full">
      <div className="relative">
        <div className="relative pb-1/2 bg-gray-200">
          <img alt=title className="absolute h-full w-full object-cover" src=image />
        </div>
        <div
        ...
        <div className="flex w-full p-6 justify-center">
          {externalLink
            ? <a className="w-full btn btn-primary" target="blank" href=link>
                <i className="fas fa-external-link-alt mr-2" /> {str(title)}
              </a>
            : <a className="w-full btn btn-primary" href=link>
                <i className="fas fa-eye mr-2" /> {str(title)}
              </a>}
        </div>
      </div>
    </div>
...
let make = () =>
  <div className="mx-auto">
    ...
    <div className="mx-auto max-w-5xl">
      ...
      <p className="-mt-1 text-sm font-sans text-center"> {str("Powered by Coronasafe")} </p>
