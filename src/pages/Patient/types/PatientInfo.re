...
let numberOfChronicDiseasedDependents = t =>
  t.numberOfChronicDiseasedDependents;
...
let decode = json =>
  Json.Decode.{
    ...
    isDeclaredPositive:
      json |> field("is_declared_positive", optional(bool)),
    ...
    numberOfChronicDiseasedDependents:
      json |> field("number_of_chronic_diseased_dependents", int),
    willDonateBlood: json |> field("will_donate_blood", optional(bool)),
    facilityObject:
      json |> field("facility_object", optional(Facility.decode)),
