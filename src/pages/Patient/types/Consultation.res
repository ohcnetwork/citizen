type t = {
  ...
  admission_date: option<Js.Date.t>,
  admitted: bool,
...
let admission_date = t => t.admission_date
...
let decode = json => {
  open Json.Decode
  {
    ...
    admission_date: json |> field("admission_date", optional(DateFns.decodeISO)),
    ...
    ip_no: json |> field("ip_no", optional(string)),
